...
# LSS this jaxified version of the clebschGordan class is from the Bayesian LISA Inference Package (BLIP)
# from Sharan Banagiri and Alexander Criswell
# https://github.com/criswellalexander/blip/blob/99c7128dd5dcbd76163200c607033d2efa94f4bd/blip/src/clebschGordan.py
